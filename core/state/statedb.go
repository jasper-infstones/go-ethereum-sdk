...
import (
	...
	"github.com/jasper-infstones/go-ethereum-sdk/trie/triestate"
)
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/jasper-infstones/go-ethereum-sdk/pull/16485#issuecomment-380438527),

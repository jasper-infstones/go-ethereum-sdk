...
import (
	...
	"github.com/jasper-infstones/go-ethereum-sdk/cmd/utils"
	...
	"github.com/jasper-infstones/go-ethereum-sdk/ethclient"
...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/jasper-infstones/go-ethereum-sdk/issues")
		}
		if err != nil {
			if err = sendError(wsconn, err); err != nil {

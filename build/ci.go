...
import (
	...
	"github.com/jasper-infstones/go-ethereum-sdk/crypto/signify"
	"github.com/jasper-infstones/go-ethereum-sdk/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/jasper-infstones/go-ethereum-sdk/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/jasper-infstones/go-ethereum-sdk/internal/version.gitDate="+env.Date)
	}
